...
upload_dir = 'C:\\PF\\Projeto_final\\web\\website\\static\\uploads'
...
def find_similar_images(uploaded_image_path, features, filenames, labels, top_n=5):
    ...
    label_indices = [i for i, label in enumerate(labels) if label == predicted_label]
    ...
    filtered_similarities = cosine_similarity([uploaded_image_features], filtered_features)
